...
<html lang="en">
  <head>
    ...
    <link href="../node_modules/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-iYQeCzEYFbKjA/T2uDLTpkwGzCiq6soy8tYaI1GyVh/UjpbCx/TYkiZhlZB6+fzT" crossorigin="anonymous">
...
<div class="sidebar d-none d-lg-flex" id="sideBar" >
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 bg-light"  style="width: 280px;">
    <!-- <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
      ...
      <span class="fs-6">Cedrick James Orozo</span>
    </a> -->
    <div class="containerName row">
        ...
        <div class="pink col-8">
            <div class="name col-12">Cedrick James Orozo</div>
            <div class="green col-12 row">
                <div class="downlineLabel col-6">Downline</div>
                
                <div class="col-1">
                <i class="fa fa-user fa-sm"></i>
                </div>

                <div class="numbersOfDownline col-4">12</div>
            </div>
        </div>
    </div>
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="#" class="nav-link " id="v-pills-disabled-tab" data-bs-toggle="pill" data-bs-target="#v-pills-disabled" type="button" role="tab" aria-controls="v-pills-disabled" aria-selected="false">
